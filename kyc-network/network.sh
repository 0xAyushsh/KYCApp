...
function createOrgs() {
  ...
  while :
    do
      if [ ! -f "organizations/fabric-ca/sbibank/tls-cert.pem" ]; then
        sleep 1
      else
        break
      fi
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/sbibank/msp organizations/fabric-ca/sbibank/tls-cert.pem organizations/fabric-ca/sbibank/ca-cert.pem organizations/fabric-ca/sbibank/IssuerPublicKey organizations/fabric-ca/sbibank/IssuerRevocationPublicKey organizations/fabric-ca/sbibank/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/icicibank/msp organizations/fabric-ca/icicibank/tls-cert.pem organizations/fabric-ca/icicibank/ca-cert.pem organizations/fabric-ca/icicibank/IssuerPublicKey organizations/fabric-ca/icicibank/IssuerRevocationPublicKey organizations/fabric-ca/icicibank/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/citibank/msp organizations/fabric-ca/citibank/tls-cert.pem organizations/fabric-ca/citibank/ca-cert.pem organizations/fabric-ca/citibank/IssuerPublicKey organizations/fabric-ca/citibank/IssuerRevocationPublicKey organizations/fabric-ca/citibank/fabric-ca-server.db'
